...
Each number represents a position in the 1st part of a row. This way you collect a writer's 
name which you have to output.
...
with open(sys.argv[1],'r') as test_cases:
	for test in test_cases:
		if test.strip():
			...
			numList=map(int,splitLine[1].split())
			for num in numList:
				res+=splitLine[0][num-1]
			print(res)
